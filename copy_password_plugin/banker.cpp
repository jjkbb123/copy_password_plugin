...
int main() {
	...
	while (1) {
		int id, req[M];
		cout << "\nPlease input you want distribute process and resource count." << endl;
		cin >> id;
		if (id == 9999)break;
		...
		switch (res) {
		case 0: cout << "Distribute success!" << endl; myoutput(); break;
		case 1: cout << "Distribute failed!		The requested resource count is exceed biggest!" << endl; break;
		case 2: cout << "Distribute failed! There are not enough resources in the system to P" << id
			<< " application!" << endl; break;
		case 3: cout << "Distribute failed!"
			<< endl; break;
		}
	}
	return 0;
